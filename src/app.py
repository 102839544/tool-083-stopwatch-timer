...
class App:
    ...
    def setup_ui(self):
        ...
        tk.Label(title_frame, text="📦 秒表计时器", font=("Arial", 18, "bold"),
        ...
        # 根据工具名称添加特定功能
        if "timer" in "stopwatch-timer".lower() or "clock" in "stopwatch-timer".lower():
            self.setup_timer_ui(main)
        elif "random" in "stopwatch-timer".lower() or "dice" in "stopwatch-timer".lower() or "coin" in "stopwatch-timer".lower():
            self.setup_random_ui(main)
        elif "note" in "stopwatch-timer".lower() or "todo" in "stopwatch-timer".lower():
    ...
    def generate_random(self):
        if "dice" in "stopwatch-timer".lower():
            result = random.randint(1, 6)
            self.result_label.config(text=f"🎲 {result}")
        elif "coin" in "stopwatch-timer".lower():
